...
def solve_langevin(parameters, tmax=400, PLOT=True):
  ...
  if PLOT == True:
    ...
    ax.set_xticks(arange(0, pi/w*17, pi/w), arange(0, 17, 1), fontsize=13)
    ax.set_xlabel(r'$t$ [$10^5$ years]', fontsize=13)
    ax.set_yticks(arange(-2*T_2, 3*T_2, T_2), [r'$-2T_0$', r'$-T_0$', '0', r'$T_0$', r'$2T_0$'], fontsize=13)
...
ax1.plot(x, y)
ax1.set_yticks(arange(-T_2, 2*T_2, T_2), [r'$-T_0$', '0', r'$T_0$'], fontsize=13)
ax1.set_ylabel(r'Low $g$', fontsize=13)

# High noise, high force strength 
ax2 = ax[1]
x, y = solve_langevin([100, -10, 10, 10, 0.25/2, 7], PLOT=False)
ax2.plot(x, y)
ax2.set_yticks(arange(-T_2, 2*T_2, T_2), [r'$-T_0$', '0', r'$T_0$'], fontsize=13)

# Low force strength
ax3 = ax[2]
x, y = solve_langevin([100, -10, 10, 1, 0.25/2, 7], PLOT=False)
ax3.plot(x, y)
ax3.set_yticks(arange(-T_2, 2*T_2, T_2), [r'$-T_0$', '0', r'$T_0$'], fontsize=13)
w = 0.25/2
ax3.set_xticks(arange(0, pi/w*17, pi/w), arange(0, 17, 1), fontsize=13)
ax3.set_xlabel(r'$t$ [$10^5$ years]', fontsize=13)
ax3.set_ylabel(r'Low $\varepsilon$', fontsize=13)
...
ax1.plot(x, y)
ax1.set_yticks(arange(-T_2, 2*T_2, T_2), [r'$-T_0$', '0', r'$T_0$'], fontsize=13)
ax1.set_ylabel(r'High $\omega$', fontsize=13)
...
ax3.plot(x, y)
ax3.set_yticks(arange(-T_2, 2*T_2, T_2), [r'$-T_0$', '0', r'$T_0$'], fontsize=13)
ax3.set_xticks(arange(0, pi/w_k*16, pi/w_k), arange(0, 16, 1), fontsize=13)
ax3.set_xlabel(r'$t$ [$10^5$ years]', fontsize=13)
ax3.set_ylabel(r'Low $\omega$', fontsize=13)
